...
{elements}
  ...
  Const_EdtLst : array [1..40] of string = ('Edt_CaracterID', 'Edt_WpnS1', 'Edt_WpnS10', 'Edt_WpnS2', 'Edt_WpnS3', 'Edt_WpnS4', 'Edt_WpnS5', 'Edt_WpnS6',
    'Edt_WpnS7', 'Edt_WpnS8', 'Edt_WpnS9', 'Edt_RS1', 'Edt_RS10', 'Edt_RS11', 'Edt_RS12', 'Edt_RS2', 'Edt_RS3', 'Edt_RS4', 'Edt_RS5', 'Edt_RS6', 'Edt_RS7',
    'Edt_RS8', 'Edt_RS9', 'Edt_TechS1', 'Edt_TechS2', 'Edt_TechS3', 'Edt_TechS4', 'Edt_TechS5', 'Edt_TechS6', 'Edt_TechS7', 'Edt_TechS8', 'Edt_TechS9', 'Edt_AS1',
    'Edt_AS2', 'Edt_AS3', 'Edt_AS4', 'Edt_AS5', 'Edt_AS6', 'Edt_AS7', 'Edt_SelectedCrt');
  Const_GrpLst : array[0..12] of string = ('Grp_CurUnit', 'Grp_WpnSkill', 'Grp_WpnCurrLvl', 'Grp_WpnAplyLvl', 'Grp_GnSkill', 'Grp_GnCurrLvl',
    'Grp_GnAplyLvl', 'Grp_TechSkill', 'Grp_TechCurrLvl', 'Grp_TechAplyLvl', 'Grp_CurUnitAtrSkill', 'Grp_AtrCurrLvl', 'Grp_AtrAplyLvl');
...
{Translation}
  ...
  Const_EdtTrLst : array[1..40] of array[0..1] of string = (('Total Units', 'Всего юнитов'), ('Blunt weapons', 'Дробящее'), ('Handgun', 'Пистолеты'), ('smg', 'Пист.-пулемёт'),
    ...
    ('Shotgun', 'Дробовики'), ('Calvin Backer skill', '"Знаток запада"'), ('Barter', 'Меняла'), ('weapon smith', 'Оружейник'), ('Manipulate', 'Хитрожопый'),
    ('Combat shooting', 'Стрелок'), ('Outdoorsman', 'Выживание'), ('Brute force', 'Грубая сила'), ('Animal Whisperer', 'Дрессировщик'), ('Spot lie', 'Жополиз'),
    ('Intimidate', 'Задира'), ('Perception', 'Зоркий глаз'), ('Leadership', 'Лидерство'), ('Demolitions', 'Взрывотехника'), ('Computer tech', 'Компьютеры'),
    ('Mechanical repair', 'Механика'), ('Field medic', 'Полевая мед.'), ('Toaster repair', 'Ремонт тостеров'), ('Alarm disarm', 'Снятие сигнализ.'), ('Doctor', 'Хирургия'),
    ('Safe crack', 'Взлом сейфов'), ('PickLock', 'Взлом замков'), ('Coordination', 'Координация'), ('Luck', 'Удача'), ('Awareness', 'Восприятие'), ('Strength', 'Сила'),
    ('Speed', 'Скорость'), ('Intelligence', 'Интеллект'), ('Charisma', 'Харизма'), ('Selected SaveGame', 'выбранный SaveGame'));
  ...
  Const_LblTrLst : array[1..6] of array[0..1] of string = (('Sex', 'Пол'), ('Age', 'Возраст'), ('Level', 'Уровень'), ('Current HP', 'Tекущие HP'),
    ('Max HP', 'Максимальные HP'), ('Free Skils', 'Свободные Skil'+#39+'ы'));
  Const_MItTrLst : array[1..8] of array[0..1] of string = (('Developer', 'Разработчик'), ('Help', 'О проекте (Help)'), ('Contact', 'Контакты'),
    ('Buy coffee for developer', 'Купить кофе разработчику'), ('Follow on patreon', 'поддержать на Patreon'), ('Info', 'Инфо'), ('About project', 'О проекте'),
